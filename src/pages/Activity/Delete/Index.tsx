...
const Delete = () => {
  ...
  useEffect(() => {
    const getActivity = async () => {
      try {
        const { data } = await axios.get(`/activity/select/${uuid}`, {
  ...
  return (
    <>
      <Breadcrumb pageName="Deletar Atividade" />
              ...
              <div className="hidden w-full xl:block xl:w-1/2">
                <div className="py-17.5 px-26 text-center">
                  ...
                  <p className="2xl:px-20 text-red-400">
                    Deletar uma atividade é uma ação irreversível e definitiva, resultando na perda
                    permanente de todos os dados associados. Essa decisão deve ser tomada com
                    extrema cautela. Recomendamos fortemente considerar deixar a atividade,
